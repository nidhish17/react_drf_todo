...
const Modal = function () {
    ...
    return (
        <div onPointerDown={closeModal}
            ...
            <div ref={modalRef} onPointerDown={(e) => e.stopPropagation()}
                 className="flex w-full flex-col flex-wrap text-wrap gap-6 max-w-xl text-neutral-10 p-4 sm:p-8 rounded bg-zinc-700/50 relative">
